...
Original file is located at
    https://colab.research.google.com/drive/18A_AOWbiNaWcbov6P2eN9kLE6zad5lM2
"""
...
class dashb:
  def __init__(self,semana,ano):
    ...
    df_estatistica = df.sort_values(by=['Palavras'],ascending = False).reset_index(drop=True)
